...
[![Build Status](https://travis-ci.org/htkachuk/btcwallet.png?branch=master)](https://travis-ci.org/htkachuk/btcwallet)
...
can be found [here](https://github.com/htkachuk/btcd).  An alternative
...
https://github.com/htkachuk/btcd/releases

https://github.com/htkachuk/btcwallet/releases
...
```
git clone https://github.com/htkachuk/btcwallet $GOPATH/src/github.com/htkachuk/btcwallet
cd $GOPATH/src/github.com/htkachuk/btcwallet
glide install
```
...
```
PS> cp $env:GOPATH\src\github.com\htkachuk\btcd\sample-btcd.conf $env:LOCALAPPDATA\Btcd\btcd.conf
PS> cp $env:GOPATH\src\github.com\htkachuk\btcwallet\sample-btcwallet.conf $env:LOCALAPPDATA\Btcwallet\btcwallet.conf
PS> $editor $env:LOCALAPPDATA\Btcd\btcd.conf
PS> $editor $env:LOCALAPPDATA\Btcwallet\btcwallet.conf
```
...
```bash
$ cp $GOPATH/src/github.com/htkachuk/btcd/sample-btcd.conf ~/.btcd/btcd.conf
$ cp $GOPATH/src/github.com/htkachuk/btcwallet/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
...
The [integrated github issue tracker](https://github.com/htkachuk/btcwallet/issues)
