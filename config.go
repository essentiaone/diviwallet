...
type config struct {
	...
	LegacyRPCListeners     []string                `long:"rpclisten" description:"Listen for legacy RPC connections on this interface/port (default port: 51472, testnet: 51476, simnet: 51476)"`
