...
[![GoDoc](https://godoc.org/github.com/essentiaone/diviwallet/walletdb?status.png)]
(http://godoc.org/github.com/essentiaone/diviwallet/walletdb)
...
http://localhost:6060/pkg/github.com/essentiaone/diviwallet/walletdb

## Installation

```bash
$ go get github.com/essentiaone/diviwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/essentiaone/diviwallet/walletdb#example-package--BasicUsage)  
