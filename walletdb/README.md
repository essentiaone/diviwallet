...
[![GoDoc](https://godoc.org/github.com/essentiaone/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/essentiaone/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/essentiaone/btcwallet/walletdb

## Installation

```bash
$ go get github.com/essentiaone/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/essentiaone/btcwallet/walletdb#example-package--BasicUsage)  
