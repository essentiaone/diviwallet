...
[![GoDoc](https://godoc.org/github.com/htkachuk/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/htkachuk/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/htkachuk/btcwallet/walletdb

## Installation

```bash
$ go get github.com/htkachuk/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/htkachuk/btcwallet/walletdb#example-package--BasicUsage)  
